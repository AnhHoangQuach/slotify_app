...
$(document).on('change', 'select.playlist', function () {
  ...
  $.post('../slotify_app/includes/handlers/ajax/addToPlaylist.php', {
...
function removeFromPlaylist(button, playlistId) {
  ...
  $.post('../slotify_app/includes/handlers/ajax/removeFromPlaylist.php', {
    playlistId: playlistId,
    songId: songId,
  }).done(function (error) {
    if (error != '') {
...
function createPlaylist() {
  ...
  if (popup != null) {
    $.post('../slotify_app/includes/handlers/ajax/createPlaylist.php', {
      name: popup,
...
function updateEmail(emailClass) {
  ...
  $.post('../slotify_app/includes/handlers/ajax/updateEmail.php', {
    email: emailValue,
    username: userLoggedIn,
...
function updatePassword(oldPasswordClass, newPasswordClass1, newPasswordClass2) {
  ...
  $.post('../slotify_app/includes/handlers/ajax/updatePassword.php', {
...
function deletePlaylist(playlistId) {
  ...
  if (prompt == true) {
    $.post('../slotify_app/includes/handlers/ajax/deletePlaylist.php', {
      playlistId: playlistId,
    }).done(function (error) {
      if (error != '') {
        alert(error)
